...
-- Generated on: 2022-03-29 22:27:02
-- -------------------------------------------------------------
...
PACKAGE filter_tb_pkg IS
  ...
  -- Type Definitions
  TYPE filter_in_data_log_type IS ARRAY (0 TO 4478) OF std_logic_vector(15 DOWNTO 0);
...
-- Counter to generate Addr.
    ...
    ELSIF clk'event and clk = '1' THEN
      IF rdenb = '1' THEN
        IF (addr = TO_UNSIGNED(4478, 13 )) THEN
          addr     <= addr; 
        ELSE
...
-- Done Signal generation.
    ...
    ELSIF (addr = TO_UNSIGNED(4478, 13 )) THEN
      done <= '1'; 
    ELSE
      done <= '0'; 
    END IF;
...
ARCHITECTURE rtl OF filter_tb IS
  ...
  CONSTANT MAX_ERROR_COUNT                : integer := 4479; -- uint32
